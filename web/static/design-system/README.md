...
│   ├── TYPOGRAPHY.md      SUIT 타이포 + 숫자 표현 규칙
...
| 라이브러리 | 용도 | 라이선스 | 크기 |
|----------|------|---------|------|
| [SUIT](https://github.com/sunn-us/SUIT) | 폰트 | SIL OFL (무료) | ~120KB (서브셋) |
...
외부 라이브러리(SUIT, Tabler Icons)는 각자의 라이선스를 따릅니다.
