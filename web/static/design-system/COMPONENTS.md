...
- 트랙 높이: 6px
- 트랙 배경: `--color-bg-muted` (#F1EFEB)
- 활성 구간: `--color-brand-primary`
- 핸들: 18x18px, 흰 배경 + 빨강 테두리 2px
- 핸들 호버 시: 약간 커지고 그림자 강해짐
- 값 표시: 상단에 "15~30분" 형식, tabular nums 적용
...
|------|--------|
| **Default** | 기본 카드 |
| **Recommended** | 상단에 "BEST MATCH" 배지, 좌측에 빨강 액센트 라인 (4px) |
| **Compact** | 한 줄짜리, 리스트뷰용. 가격만 강조 |
