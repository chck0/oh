...
- [x] AC1: 결과 화면 추천 목록 위에 검색 인풋 표시
- [x] AC2: 아파트 이름 자동완성 드롭다운 + 최대 3개 후보 카드 표시
- [x] AC3: 카드에 가격·통근시간·세대수·준공년도 칩 표시
- [x] AC4: 카드의 친구 버튼 클릭 시 채팅 패널 열림
- [x] AC5: 단지명 클릭 → 지도 이동 + 주황 핀 + 상세 분석 패널
- [x] AC6: 즐겨찾기(♥) 버튼 추가
- [x] AC7: 기존 pytest 387+ passed 유지
